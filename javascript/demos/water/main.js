...
scene.configure(parseInt(urlParams.get("width")) || 50, parseInt(urlParams.get("height")) || 50, parseInt(urlParams.get("resolution")) || 16, parseFloat(urlParams.get("font-size")) || 1.2);
scene.reflectionCamera.lookAt([0, -5, 0], [0, 0, 0], [0, 0, -1]);
